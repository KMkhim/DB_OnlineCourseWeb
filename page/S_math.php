        ...
        <br>
            <div class="container">
                <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-top: -20px; margin-bottom: 20px;">
                    <h2 class="featurette-heading fw-normal lh-1" id="math1" style="font-family: 'Pacifico', cursive;">
    ...
    <?php  
     ...
     ?>
        ...
        <br>
            <div class="container">
            <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-top: -20px; margin-bottom: 20px;">
                <h2 class="featurette-heading fw-normal lh-1" id="math2" style="font-family: 'Pacifico', cursive;">
    ...
    <?php  
     ...
     ?>
        ...
        <br>
            <div class="container">
            <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-top: -20px; margin-bottom: 20px;">
                <h2 class="featurette-heading fw-normal lh-1" id="math3" style="font-family: 'Pacifico', cursive;">
